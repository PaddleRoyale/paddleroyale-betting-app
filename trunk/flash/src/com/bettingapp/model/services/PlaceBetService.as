package com.bettingapp.model.services
{
	...
	public class PlaceBetService extends WebServiceBase
	{
		public function PlaceBetService()
		{
			super();
			
			// setup parameters exclusive to this command.
			_urlRequest.method = URLRequestMethod.GET;
			_urlRequest.url = BASE_URL + "betting/PlaceBet";
		}
		
		protected override function onResult($e:Event):void
		{
			trace("PlaceBetService result:" + _urlLoader.data);
			...
			event.parameters.betPlaced = Boolean(result.Result);
